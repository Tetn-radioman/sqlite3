Вот простой README для SQLite3, который подойдёт для вашего GitHub-репозитория.
...
SQLite — это легковесная встраиваемая база данных, которая хранится в одном файле. Не требует сервера, идеальна для небольших проектов.
